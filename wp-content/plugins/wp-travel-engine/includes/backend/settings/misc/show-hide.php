    ...
    <div class="wpte-form-block">
        <div class="wpte-form-content">
            ...
            <div class="wpte-field wpte-checkbox advance-checkbox">
                ...
                <div class="wpte-checkbox-wrap">
                    <input type="checkbox" id="wp_travel_engine_settings[show_excerpt]" name="wp_travel_engine_settings[show_excerpt]" value="1" <?php if(isset($wp_travel_engine_settings['show_excerpt']) && $wp_travel_engine_settings['show_excerpt']!='' ) echo 'checked'; ?>>
